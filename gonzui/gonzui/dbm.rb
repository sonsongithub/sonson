...
module Gonzui
  ...
  class AbstractDBM
    ...
    def get_format_ids_from_package_id(package_id)
      @pkgid_fmtids.duplicates(package_id, false)
    end
    ...
    def get_license_ids_from_package_id(package_id)
      @pkgid_lcsids.duplicates(package_id, false)
    end
    ...
    def get_ncontents_in_package(package_name)
      ...
      @pkgid_pathids.duplicates(package_id, false).length
    end
    ...
    def get_package_ids(word_id)
      @wordid_pkgids.duplicates(word_id, false)
    end
    ...
    def get_package_options(package_id)
      options = {}
      values = @pkgid_options.duplicates(package_id, false)
      values.each {|value|
        k, v = value.split(":", 2)
        k = k.intern
        case k
